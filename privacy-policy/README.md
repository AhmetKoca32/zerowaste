# Atıksız Mutfak gizlilik politikası

Bu klasör, Google Play için yayımlanacak bağımsız ve statik gizlilik politikası sayfasını içerir.

## Vercel ile yayınlama

1. Vercel'de **Add New → Project** seçin.
2. GitHub'daki `AhmetKoca32/zerowaste` deposunu içe aktarın.
